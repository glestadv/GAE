...
//	int getNetworkConsistencyChecks() const		{return networkConsistencyChecks;}
...
//	void setNetworkConsistencyChecks(int val)	{networkConsistencyChecks = val;}
