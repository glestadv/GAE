...
public:
	...
	bool isAllocateResources() const			{return flags.get(cpAllocateResources);}
	...
	void setAllocateResources(bool allocateResources)	{flags.set(cpAllocateResources, allocateResources);}
