 ...
 * TotalUpgrade class provided most of this functionality.
 */
...
public:
	...
	void setAutoRepairEnabled(bool autoRepairEnabled)	{this->autoRepairEnabled = autoRepairEnabled;}
