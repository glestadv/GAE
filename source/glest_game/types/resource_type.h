...
private:
    ...
    int resourceNumber;	//used only if class==ResourceClass::TECH, resource number in the map
    int interval;		//used only if class==ResourceClass::CONSUMABLE
	int defResPerPatch;	//used only if class==ResourceClass::TILESET || class==ResourceClass::TECH
    Model *model;
	/**
