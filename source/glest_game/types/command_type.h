...
class AttackCommandTypeBase {
public:
	typedef vector<const AttackSkillType*> AttackSkillTypes;
protected:
...
public:
	virtual void load(int id, const XmlNode *n, const string &dir, const TechTree *tt, const FactionType *ft, const UnitType &ut);
	virtual void getDesc(string &str, const Unit *unit) const{
		attackSkillTypes.front()->getDesc(str, unit);
	}

	const AttackSkillType * getAttackSkillType() const		{return attackSkillTypes.front();}
