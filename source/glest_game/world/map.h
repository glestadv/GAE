...
public:
	...
	void load(const XmlNode *node, World *world);
	void save(XmlNode *node, int x, int y) const;
	 ...
	 * <li> 4 bits: resource number + 1 or zero if no resource</li>
	 * <li> 16 bits: if resource, the amount. Otherwise, the tileset object + 1</li>
	 * </ul>
	 */
