...
CloakType::CloakType( const UnitType *ut )
		...
		, m_group( -1 )
		, m_cost( 0 )
		, m_cloakSound( nullptr )
		, m_deCloakSound( nullptr )
		, m_allyShader( nullptr )
		, m_enemyShader( nullptr ) {
}
...
DetectorType::DetectorType( const UnitType *ut )
		...
		, m_cost( 0 )
		, m_detectionOnSound( nullptr )
		, m_detectionOffSound( nullptr )
		, m_detectionMadeSound( nullptr ) {
}
