...
public:
	...
	void setGsRandStartLocs(bool v)					{gsRandStartLocs = v;}
	...
	void setNetAutoRepairAllowed(bool v)			{netAutoRepairAllowed = v;}
	void setNetAutoReturnAllowed(bool v)			{netAutoReturnAllowed = v;}
	void setNetChangeSpeedAllowed(bool v)			{netChangeSpeedAllowed = v;}
	void setNetClientPort(int v)					{netClientPort = v;}
