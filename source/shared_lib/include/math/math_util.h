...
struct GLMatrix {
	...
	Vec4f operator*(const Vec4f &B) const {
		...
		Vec4f res;
		res.x = A._11 * B.x + A._12 * B.y + A._13 * B.z + A._14 * B.w;
		res.y = A._21 * B.x + A._22 * B.y + A._23 * B.z + A._24 * B.w;
		res.z = A._31 * B.x + A._32 * B.y + A._33 * B.z + A._34 * B.w;
		res.w = A._41 * B.x + A._42 * B.y + A._43 * B.z + A._44 * B.w;
		return res;
	}
	...
	Vec3f operator*(const Vec3f &B) {
		const GLMatrix &A = *this;
		Vec3f res;
		res.x = A._11 * B.x + A._12 * B.y + A._13 * B.z;
		res.y = A._21 * B.x + A._22 * B.y + A._23 * B.z;
		res.z = A._31 * B.x + A._32 * B.y + A._33 * B.z;
		//float w = A._41 * B.x + A._42 * B.y + A._43 * B.z;
		return res;
	}
