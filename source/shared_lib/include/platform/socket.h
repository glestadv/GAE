...
public:
	...
	void read(int16 &data)	{uint16_t a; read(&a, 2); *((uint16_t *)&data) = ntohs(a);}
	void read(uint16 &data)	{uint16_t a; read(&a, 2); *((uint16_t *)&data) = ntohs(a);}
	void read(int32 &data)	{uint32_t a; read(&a, 4); *((uint32_t *)&data) = ntohl(a);}
	void read(uint32 &data)	{uint32_t a; read(&a, 4); *((uint32_t *)&data) = ntohl(a);}
	void read(float32 &data){uint32_t a; read(&a, 4); *((uint32_t *)&data) = ntohs(a);}

	void peek(int8 &data) const		{peek(&data, 1);}
	void peek(uint8 &data) const	{peek(&data, 1);}
	void peek(int16 &data) const	{uint16_t a; peek(&a, 2); *((uint16_t *)&data) = ntohs(a);}
	void peek(uint16 &data) const	{uint16_t a; peek(&a, 2); *((uint16_t *)&data) = ntohs(a);}
	void peek(int32 &data) const	{uint32_t a; peek(&a, 4); *((uint32_t *)&data) = ntohl(a);}
	void peek(uint32 &data) const	{uint32_t a; peek(&a, 4); *((uint32_t *)&data) = ntohl(a);}
	void peek(float32 &data) const	{uint32_t a; peek(&a, 4); *((uint32_t *)&data) = ntohs(a);}

	void write(int8 data)	{write(&data, 1);}
	void write(uint8 data)	{write(&data, 1);}
	void write(int16 data)	{uint16_t a = htons(*((uint16_t *)&data)); write(&a, 2);}
	void write(uint16 data)	{uint16_t a = htons(*((uint16_t *)&data)); write(&a, 2);}
	void write(int32 data)	{uint32_t a = htonl(*((uint32_t *)&data)); write(&a, 4);}
	void write(uint32 data)	{uint32_t a = htonl(*((uint32_t *)&data)); write(&a, 4);}
	void write(float32 data){uint32_t a = htonl(*((uint32_t *)&data)); write(&a, 4);}
};
